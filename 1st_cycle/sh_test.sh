...
python train_main.py --savepath 'result' --data_path 'train.csv' --val_path 'test.csv' --model bilstm --sample_type both --over_method adasyn --under_method tomek --scaler standard --nb_class 1 --opts lookahead --lossfunc binary_crossentropy --batch_size 64 --learning_rate 0.0001 --callback_type checkpoint earlystopping tensorboard rateschedule interval_check --epoch 100 --jobs -1 --random